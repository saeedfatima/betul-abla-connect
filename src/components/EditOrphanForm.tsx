...
interface EditOrphanFormProps {
  orphan: any;
  onSubmit: (orphanData: any) => void;
  onCancel: () => void;
}

const EditOrphanForm: React.FC<EditOrphanFormProps> = ({ orphan, onSubmit, onCancel }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    monthlyAllowance: orphan.monthlyAllowance.toString(),
    schoolStatus: orphan.schoolStatus,
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Edit Orphan - {orphan.name}</CardTitle>
      </CardHeader>
      <CardContent>
